...
public class DrawingPanel extends JPanel implements Serializable {
	...
	private static final long serialVersionUID = 1L;
	    ...
	    */
        ...
        /**
         * Convert JPanel coordinate (Top-left origin, Positive ordinate down) into Simulation coordinate (Origin centered, Positive ordinate up)
         * @param p a Point vector in JPanel referential
         * @return a Vec2 vector coordinate in simulation referential
         */
        public Vec2 convert4simu(Point p) { // Change orientation of the referentiel and put to scale
        	return  new Vec2(p.x/scale + world.getXMin(), world.getYMax() - p.y/scale);
        }
